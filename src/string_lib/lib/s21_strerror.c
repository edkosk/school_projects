...
#define S21_ERRORLIST_SIZE 107
#else
#define S21_ERRORLIST_SIZE 134
#endif

#if defined(__APPLE__) || defined(__MACH__)

static const char *const s21_sys_errlist[S21_ERRORLIST_SIZE] = {
    [0] = "Undefined error: 0",
...
char *s21_strerror(int errnum) {
  ...
  if (errnum <= 0 || errnum >= S21_ERRORLIST_SIZE) {
    ...
    strcpy(result, ((char *)s21_sys_errlist[errnum]));
  }
  return result;
}
